...
@section('content')
    ...
    <main class="max-w-lg mx-auto">
        <h1 class="text-center">Edite os dados deste curso</h1>
        <br>
        <div class="inner">
            <form method="POST" action="{{ route('update.curso',['curso'=>$curso]) }}">
                @csrf
                @method('PATCH')
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea type="text"
                        ...
                        name="desc_simpl" 
                        id="desc_simpl"
                        required>{{ $curso->desc_simpl }}</textarea>
